...
1. Github에서 new repository로 이미지만 저장하는 저장소를 생성한다.(Public으로 생성해야 함!!!!)<br>
2. 본인 컴퓨터에 Git과 클론할 위치로 터미널에서 이동한다.<br>
3. git clone [본인 레파지토리 url] 명령어를 실행한다.<br>
4. 블로그에 업로드 할 이미지들을 저장소에 옮긴 후 저장소에 push 한다.<br>
